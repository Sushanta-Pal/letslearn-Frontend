...
export default function DashboardLanding() {
  ...
  return (
    <>
      <Helmet>
        <title>Placium | Advanced E-Learning & Internships</title>
        <meta name="description" content="Discover Placium: The ultimate platform connecting students and educators with real-world virtual internships, AI mock interviews, and practice arenas." />
      </Helmet>
        ...
        <header className="sticky top-0 z-50 bg-white/80 dark:bg-black/80 backdrop-blur-md border-b border-gray-200 dark:border-white/10">
          <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
            <a href="/" className="flex items-center gap-2 group">
              ...
              <span className="font-bold text-xl tracking-tight">Placium</span>
            </a>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
                <div>
                  ...
                  <p className="text-gray-300 text-lg mb-8 leading-relaxed">
                    Placium mimics a top-tier tech company workspace. You don't just watch videos; you move Jira tickets, write production code, submit Pull Requests, and debug live issues.
                  </p>
        ...
        <footer className="bg-white dark:bg-[#050505] border-t border-gray-200 dark:border-white/10 py-12 mt-12">
          <div className="max-w-7xl mx-auto px-6 text-center">
            <div className="flex justify-center items-center gap-2 mb-6">
              <div className="w-8 h-8 rounded-lg bg-[#111] dark:bg-white text-white dark:text-black flex items-center justify-center font-bold">PL</div>
              <span className="font-bold text-xl text-gray-900 dark:text-white">Placium</span>
            </div>
            <p className="text-gray-500 text-sm">
              &copy; 2026 Placium. Built for the builders.
            </p>
          </div>
        </footer>
